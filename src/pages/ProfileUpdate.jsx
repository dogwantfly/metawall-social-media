        ...
        >
          ...
          >
            <img
              ...
              alt='avatar'
              className='w-[107px] h-[107px] mx-auto mb-4 mt-8'
            />
            <button
              type='button'
            ...
            <label htmlFor='gender' className='block text-black-custom mb-2'>
              性別
            </label>
            ...
            <div className='flex justify-center mb-8'>
              <button
                ...
                className={`block w-full md:w-auto md:inline-block rounded bg-blue-custom md:px-[130px] py-4 font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] transition duration-150 ease-in-out border-2 border-black-custom ${
                  !isValid
                    ? 'disabled:opacity-50'
                    : 'hover:bg-yellow-custom hover:text-black-custom focus:bg-yellow-custom focus:text-black-custom focus:outline-none focus:ring-0 button-shadow hover:button-shadow'
                }`}
